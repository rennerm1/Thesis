...
class LRP:
    ...
    def DC_cfg(self,city, DC_N, customer_N, fixed_cost_factor, avg_basket_size, capacity_DC=[], varCost_DC =[]):    
        ...
        if self.city == "Albstadt":
            lat_DC = [ 48.2554692 , 48.2110663, 48.2304419, 48.237164, 48.222982,48.2827414]
            lon_DC = [9.0136856 ,9.022576, 8.9677358, 9.027823, 8.9184284, 9.001414]
            osmid = [290847730 ,366360585, 293003525, 248746221, 262388012, 255887075]
    ...
    def C_cfg(self,Customer_N, mean_demand, max_demand, min_demand, seed_customers, seed_demand):
        ...
        # Same Process as described above but just load them
        if self.city == "Albstadt":
        ...
        # First Sample to get the matching nodes which are in my time matrix from HERE API
        if self.city == "Albstadt":
        ...
        #Sample from initial samp_first df
        ...
        # Sample from triangular demand dist function
    ...
    def Dist_m(self,  cost_per_meter):
        ...
        # Load the Distance Matrix for the choosen market (stems from HERE API)
        if self.city == "Albstadt":
        ...
        # OLD WAY OF GETTING Distance MATRIX
    ...
    def Time_m(self, cost_per_second, service_time):
        ...
        # OLD WAY OF GETTING TIME MATRIX
        #Fs = self.Gs
        ...
        # Load right Time matrix from file (HERE API OUTPUT)
        if self.city == "Albstadt":
    ...
    # Define different Printers that show me most important information at a glance    
    def DC_Print(self):
